    ...
    <table class="table-auto">
        <thead>
            <tr>
                ...
                <th class="px-4 py-2">vision</th>
                <th class="px-4 py-2">mission</th>
                <th class="px-4 py-2">hstory</th>
                <th class="px-4 py-2">email</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="border px-4 py-2">{{ $profile->overview }}</td>
                <td class="border px-4 py-2">{{ $profile->vision }}</td>
                <td class="border px-4 py-2">{{ $profile->mission }}</td>
                <td class="border px-4 py-2">{{ $profile->history }}</td>
